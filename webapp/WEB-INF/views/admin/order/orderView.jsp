	...
	<div id="wrapper">
		<div id="contents" class="notice">
				...
				<table summary="">
					...
					<tbody>
						<c:forEach var="orderView" items="${orderView}">
							...
							<tr>
								<td class="tit"><a
									href="http://localhost:8090/user/shop/shopView?pageNum=1&amount=10&type=&keyword=&p_no=2"
									class="move"><img class="thumb"
										src="${orderView.p_thumbImg}"></a><a
									href="${orderView.p_no }" class="move">${orderView.p_name}</a></td>
			...
			<form role="form" method="post" class="statusForm">
				<%-- <input type="hidden" name="o_id" value="${orderView.o_id}" /> --%>
				<input type="hidden" name="status" class="status" value="" /> <input
					type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
				<button type="button" class="btStatus1">배송중</button>
				<button type="button" class="btStatus2">배송완료</button>
				<script>
