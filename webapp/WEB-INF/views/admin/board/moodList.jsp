...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">상황별 음악 목록</h1>
	<p class="mb-4">EAR FUN에 등록된 상황별 음악 목록입니다.</p>
	...
	<table id="dataTable" class="ui celled table"
		...
		<tfoot>
			<tr>
				<th colspan="5" style="text-align: right; white-space: nowrap;">
					전체 게시글 <label style="color: red;">${pageMaker.total}</label> 개
				</th>
			<tr>
		</tfoot>
		...
		<tbody>
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td><a href="${list.m_no}" class="move"> <c:out
								value="${list.m_caption}" /></a></td>
	...
	<div>
		<div class="col-lg-12">
			<form id="searchForm" class="searchForm"
				action="/admin/board/noticeList" method="get">
				<select name="type">
	...
	<form id="actionForm" action="/admin/board/moodList" method="get">
...
$(document).ready(function () {
   var result = '<c:out value="${result}"/>';
      ...
      $(".move").on("click", function (e) {
         e.preventDefault();
         actionForm.append("<input type='hidden' name='m_no' "
            + "value='" + $(this).attr("href") + "'>");
         actionForm.attr("action", "/admin/board/moodView");
         actionForm.submit();
      });
