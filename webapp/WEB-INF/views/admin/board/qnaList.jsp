...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">1:1 문의 목록</h1>
		...
		<tfoot>
			<tr>
				<th colspan="7" style="text-align: right; white-space: nowrap;">
					전체 1:1 Q&A <label style="color: red;">${pageMaker.total}</label> 개
				</th>
			<tr>
		</tfoot>
		...
		<tbody>
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td><a href="${list.q_no}" class="move"><c:out
								value="${list.q_title }" /></a></td>
					<td><c:out value="${list.q_contents }" /></td>
	...
	<div>
		<div class="col-lg-12">
			<form id="searchForm" class="searchForm"
				action="/admin/board/earFunList" method="get">
				<select name="type">
			...
			function() {
				...
				$(".move").on(
						...
						function(e) {
							e.preventDefault();
							actionForm
									.append("<input type='hidden' name='q_no' "
											+ "value='" + $(this).attr("href")
											+ "'>");
							actionForm.attr("action", "/admin/board/qnaView");
							actionForm.submit();
						});
