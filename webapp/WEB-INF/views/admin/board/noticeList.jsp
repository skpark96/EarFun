...
<div class="container-fluid">
	...
	<p class="mb-4">EAR FUN에 등록된 공지사항 목록입니다.</p>
	...
	<table id="dataTable" class="ui celled table"
		...
		<tfoot>
			<tr>
				<th colspan="3" style="text-align: right; white-space: nowrap;">
		...
		<tbody>
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td><a href="${list.n_no}" class="move"> <c:out
	...
	<form id="actionForm" action="/admin/board/noticeList" method="get">
...
$(document).ready(function () {
   var result = '<c:out value="${result}"/>';
      ...
      $(".move").on("click", function (e) {
         ...
         actionForm.attr("action", "/admin/board/noticeView");
         actionForm.submit();
      });
