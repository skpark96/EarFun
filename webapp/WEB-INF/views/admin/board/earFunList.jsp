...
<main class="page-content">
   ...
   <!-- Page Heading -->
   <h1 class="h3 mb-2 text-gray-800">이어펀's Pick 목록</h1>
   <p class="mb-4">EAR FUN에 등록된 이어펀's Pick 목록입니다.</p>
      ...
      <tbody>
         <c:forEach var="list" items="${list}">
            <tr>
               ...
               <td><a href="${list.e_no}" class="move"> 
                  <c:out value="${list.e_caption}" /></a></td>
   ...
   <form id="actionForm" action="/admin/board/earFunList" method="get">
      <input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}"> 
      <input type="hidden" name="amount" value="${pageMaker.cri.amount}">
...
$(document).ready(function () {
   var result = '<c:out value="${result}"/>';
      ...
      $(".move").on("click", function (e) {
         e.preventDefault();
         actionForm.append("<input type='hidden' name='e_no' "
            + "value='" + $(this).attr("href") + "'>");
         actionForm.attr("action", "/admin/board/earFunView");
         actionForm.submit();
      });
