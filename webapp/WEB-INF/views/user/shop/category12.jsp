...
<div class="signUp-page">
	<h1 class="title">악세서리</h1>
	<hr>
	<!-- <h6 class="m-0 font-weight-bold text-primary">DataTables Example</h6> -->
	<a href="http://localhost:8090/user/shop/category10" class="category00">전체&nbsp;&nbsp;&nbsp;</a>
	<a href="http://localhost:8090/user/shop/category11" class="category01">케이블&nbsp;&nbsp;&nbsp;</a>
	<a href="http://localhost:8090/user/shop/category12" class="category02">케이스/파우치&nbsp;&nbsp;&nbsp;</a>
	<a href="http://localhost:8090/user/shop/category13" class="category03">청소도구&nbsp;&nbsp;&nbsp;</a>
	<br>
	<hr>
	<div style="text-align: left;">
		<strong>${pageMaker.total } 개</strong> <a
			href="http://localhost:8090/user/shop/lowPriceCategory12"
			class="lowPrice">낮은가격</a> <a
			href="http://localhost:8090/user/shop/highPriceCategory12"
