...
<div class="signUp-page">
	<h1 class="title">AUKEY</h1>
	<!-- <h6 class="m-0 font-weight-bold text-primary">DataTables Example</h6> -->
	<br>
	<hr>
	<div style="text-align: left;">
	<strong>${pageMaker.total } 개</strong> <a
		href="http://localhost:8090/user/shop/brand/lowPriceAukey" class="lowPrice">낮은가격</a>
	<a href="http://localhost:8090/user/shop/brand/highPriceAukey" class="highPrice">높은가격&nbsp;&nbsp;&nbsp;</a>
	</div>
	<hr>
