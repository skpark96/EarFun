...
<div class="signUp-page">
	<h1 class="title">NEXUM</h1>

	<br>
	<hr>
	<div style="text-align: left;">
	<strong>${pageMaker.total } 개</strong> <a
		href="http://localhost:8090/user/shop/brand/lowPriceNexum" class="lowPrice">낮은가격</a>
	<a href="http://localhost:8090/user/shop/brand/highPriceNexum" class="highPrice">높은가격&nbsp;&nbsp;&nbsp;</a>
	</div>
	<hr>
