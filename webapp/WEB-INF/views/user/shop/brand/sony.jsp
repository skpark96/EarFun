...
<div class="signUp-page">
	...
	<strong>${pageMaker.total } 개</strong> <a
		href="http://localhost:8090/user/shop/brand/lowPriceSony" class="lowPrice">낮은가격</a>
	<a href="http://localhost:8090/user/shop/brand/highPriceSony" class="highPrice">높은가격&nbsp;&nbsp;&nbsp;</a>
	</div>
	<hr>
