...
<link rel="stylesheet" href="/resources/css/user/report.css">
<link rel="stylesheet"
		...
		<form role="form" action="/user/board/report" method="post"
			...
			<c:forEach var="report" items="${report}">
				<input type="hidden" name="${_csrf.parameterName}"
					value="${_csrf.token}" />
				<label for="r_writer">작성자</label>
				<input type="text" id="r_writer" name="r_writer"
					value="${report.u_id }" readonly="readonly">

				<label for="r_contents">신고 내용</label>
				<input type="text" id="r_contents" name="r_contents"
					value="${report.r_contents }" readonly="readonly">

				<label for="r_reason">신고 사유</label>
				<br>
				<textarea rows="5" name="r_reason" id="r_reason"
					placeholder="(이쪽을 클릭하시면 신고 사유를 작성할 수 있습니다.)"
					style="width: 410px; Noto Sans KR, sans-serif; font-weight: 500; font-size: 12pt; color: #000;"></textarea>
