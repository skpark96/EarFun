	...
	<div class="signUp-page">
		...
		<div class="totalProducts">
			...
			<div class="dummy">
				<section class="contents">
					<ul class="info">
						<c:forEach var="list" items="${list}">
							<li class="brd_list"><a href="${list.e_no}" class="move">
									<img src="${list.e_thumbImg}" class="thumbImg" /><br> <br>
							</a> <strong> <a href="${list.e_no}" class="move"
									style="font-size: 18px; color: #1c1c1c;"> <c:out
											value="${list.e_caption}" /><br> <br></a>
							</strong>
								<div class="price">
									조회수&nbsp;
				...
				<form id="categoryForm" action="/user/board/earFunList" method="get">
			...
			function() {
				...
				$(".move").on(
						...
						function(e) {
							e.preventDefault();
							categoryForm
									.append("<input type='hidden' name='e_no' "
											+ "value='" + $(this).attr("href")
											+ "'>");
							categoryForm.attr("action",
									"/user/board/earFunView");
							categoryForm.submit();
						});
			}); // end of ready
</script>
